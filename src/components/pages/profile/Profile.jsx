      ...
      <div className="card">
        ...
        <div className="card-reveal">
          ...
          <p className="flex-container">
            <a href="https://github.com/nituabianca">
              <i className="fab fa-github grey-text text-darken-4 social_style"></i>
            </a>
            <a href="https://www.linkedin.com/in/bianca-ni%C8%9Bu-a1434b1b9/">
              <i className="fab fa-linkedin grey-text text-darken-4 social_style">
                {" "}
              </i>
            </a>
            <a href="https://www.facebook.com/nitu.andreeabianca/">
              <i className="fab fa-facebook-f grey-text text-darken-4 social_style"></i>
            </a>
            <a href="https://www.instagram.com/bianca_a_nitu/">
